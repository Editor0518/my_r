...
public class UnderLetter
{
    ...
    /// 하햐허혀호효후휴흐히헤혜해햬
    /// </summary>
    static string no_underletter = "가갸거겨고교구규그기게계개걔까꺄꺼껴꼬꾜꾸뀨끄끼께꼐깨꺠나냐너녀노뇨누뉴느니네녜내냬다댜더뎌도됴두듀드디데뎨대댸따땨떠뗘또뚀뚜뜌뜨띠떼뗴때떄라랴러려로료루류르리레례래럐마먀머며모묘무뮤므미메몌매먜바뱌버벼보뵤부뷰브비베볘배뱨빠뺘뻐뼈뽀뾰뿌쀼쁘삐뻬뼤빼뺴사샤서셔소쇼수슈스시세셰새섀싸쌰써쎠쏘쑈쑤쓔쓰씨쎄쎼쌔썌아야어여오요우유으이에예애얘자쟈저져조죠주쥬즈지제졔재쟤짜쨔쩌쪄쪼쬬쭈쮸쯔찌쩨쪠째쨰차챠처쳐초쵸추츄츠치체쳬채챼카캬커켜코쿄쿠큐크키케켸캐컈타탸터텨토툐투튜트티테톄태턔파퍄퍼펴포표푸퓨프피페폐패퍠하햐허혀호효후휴흐히헤혜해햬";
    ...
    public static bool HasUnderLetter(string str)
    {
        ...
        {
            if (c.Equals(no_underletter[i])) { hasUnderletter = false; Debug.Log(str + "가~~  " + str + "는~~"); break; }
