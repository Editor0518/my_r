...
public class UnderLetter
{
    ...
    public static string SetUnderLetterEnd(string str, string endLetter)
    {
        ...
        switch (endLetter)
        {
            ...
            case "이든":
            case "든":
                return hasUnderletter ? "이든" : "든";
            case "와는":
            case "과는":
                return hasUnderletter ? "와는" : "과는";
            case "이랑은":
            case "랑은":
                return hasUnderletter ? "이랑은" : "랑은";
            case "이라도":
            case "라도":
                return hasUnderletter ? "이라도" : "라도";
            case "으로":
            case "로":
                return hasUnderletter ? "으로" : "로";
    ...
    public static string SetUnderLetter(string str, string endLetter)
    {
